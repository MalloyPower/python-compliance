...
PLOT_PDF = 'author-plots.pdf'

DATA_FILE = os.path.join('data','authors.txt')
SEP = '&'
...
if __name__ == '__main__':
    ...
    plot_authors(all_authors, 'No. of committers', np.arange(0, 1700, 100), False, 'authors-box.pdf')
    plot_authors(all_creators, 'No. of creators', np.arange(0, 340, 20), False, 'creators-box.pdf')
