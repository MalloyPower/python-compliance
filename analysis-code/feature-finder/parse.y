...
%{
  ...
  int set_count = 0;
  int set_comprehension  = 0;
  int dict_comprehension = 0;
  int extra_func_parens  = 0;
  int with_as_count = 0;
%}
...
fplist // Used in: fpdef
	: fpdef star_fpdef_notest COMMA {$$ = $1 || $2;}
	| fpdef star_fpdef_notest { $$ = $1 || $2; }
	;
...
with_stmt // Used in: compound_stmt
	: WITH with_item star_COMMA_with_item COLON suite
        { if ($3>0) ++ with_as_count; }
	;
star_COMMA_with_item // Used in: with_stmt, star_COMMA_with_item
        : star_COMMA_with_item COMMA with_item { $$=$1+1;}
        | %empty { $$=0; }
	;
